...
class Map:
    ...
    def difference(self, path: str | Path, *others, select=Op.Last) -> Buffer | None: ...

    def intersection(self, path: str | Path, *others, select=Op.Last) -> Buffer | None: ...

    def symmetric_difference(self, path: str | Path, *others, select=Op.Last) -> Buffer | None: ...

    def union(self, path: str | Path, *others, select=Op.Last) -> Buffer | None: ...
...
class Set:
    ...
    def difference(self, path: str | Path, *others) -> Buffer | None: ...

    def intersection(self, path: str | Path, *others) -> Buffer | None: ...

    def symmetric_difference(self, path: str | Path, *others) -> Buffer | None: ...

    def union(self, path: str | Path, *others) -> Buffer | None: ...
