...
class Map:
    ...
    @classmethod
    def difference(cls, *maps, select=Op.Last) -> Iterator[Tuple[bytes, int]]: ...

    @classmethod
    def intersection(cls, *maps, select=Op.Last) -> Iterator[Tuple[bytes, int]]: ...

    @classmethod
    def symmetric_difference(cls, *maps, select=Op.Last) -> Iterator[Tuple[bytes, int]]: ...

    @classmethod
    def union(cls, *maps, select=Op.Last) -> Iterator[Tuple[bytes, int]]: ...
